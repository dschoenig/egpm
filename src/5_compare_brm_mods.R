...
if(mod.id == 25) {
  ...
  priors <- c(
              ...
              prior(normal(0, 5), class = Intercept, dpar = nu),
              prior(normal(0, 3), class = sd, dpar = nu),
              prior(normal(0, 5), class = Intercept, dpar = sigma),
              prior(normal(0, 3), class = sd, dpar = sigma))
...
if(mod.id == 26) {
  ...
  mod.form <-
    bf(mar.std ~ 1 + (1 |m| name.short) + (1 | ls.uid),
       nu ~ 1 + (1 |m| name.short),
       sigma ~ 1 + (1 |m| name.short))
...
if(mod.id == 27) {
  ...
  mod.form <-
    bf(mar.std ~ 1 +
                 (1 |r| ls.response) +
                 (1 |i| ls.imbalance:ls.response) +
                 (1 |m| name.short:ls.imbalance:ls.response),
       nu ~ 1 +
            (1 |r| ls.response) +
            (1 |i| ls.imbalance:ls.response) +
            (1 |m| name.short:ls.imbalance:ls.response),
...
if(mod.id == 32) {
  ...
  mod.form <-
    bf(mar.std ~
         0 + name.short*ls.response*ls.imbalance,
       nu ~
         0 + name.short*ls.response*ls.imbalance,
       sigma ~
         0 + name.short*ls.response*ls.imbalance)
